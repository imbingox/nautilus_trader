...
WHEEL_NAME = "nautilus_trader_papi-2.0.0rc9-cp314-cp314-manylinux_2_34_x86_64.whl"
...
def _wheel(
    ...
    *,
    ...
    dist_info = "nautilus_trader_papi-2.0.0rc9.dist-info"
    metadata = "\n".join(
        [
...
def test_verify_wheel_accepts_frozen_release_contract(tmp_path: Path) -> None:
    ...
    assert report["version"] == "2.0.0rc9"
